...
export let Notes: Note[] = [
    {id: 1, createdOn: new Date("2019-05-01 19:38"), issueID: 2, userID: 1, statusID: 1, text: "Created this ticket for you, please hit it first thing in the morning."},
    {id: 2, createdOn: new Date("2019-05-02 09:22"), issueID: 2, userID: 2, statusID: 2, text: "Starting to work on this now. Will keep you updated."}
]
